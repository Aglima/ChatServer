<?php
    ...
    while(true) {
        ...
        if(in_array($socket, $changed)) {
            ...
            $response = mask(json_encode(array('type' => 'system', 'message' => $ip.' ist dem Chat beigetreten.')));
        ...
        foreach($changed as $changed_socket) {
            while(socket_recv($changed_socket, $buf, 1024, 0) >= 1) {
                ...
                if(!$tst_msg = json_decode($received_text)) {
                    break 2;
                }
            ...
            if($buf === false) {
                ...
                $response = mask(json_encode(array('type' => 'system', 'message' => $ip . ' hat den Chat verlassen.')));
                send_message($response);
            }
        }
    }
